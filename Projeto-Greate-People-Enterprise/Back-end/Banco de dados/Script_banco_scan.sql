...
--Insert Oferta Vaga
insert into tb_ofertavagas (idvaga, quantidade_vaga) values (1,'999');
insert into tb_ofertavagas (idvaga, quantidade_vaga) values (2,'10');
insert into tb_ofertavagas (idvaga, quantidade_vaga) values (3,'3');
insert into tb_ofertavagas (idvaga, quantidade_vaga) values (4,'15');
insert into tb_ofertavagas (idvaga, quantidade_vaga) values (5,'110');
